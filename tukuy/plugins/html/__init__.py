...
Canonical home for all HTML-related transformer classes.  The old
``tukuy.transformers.html`` module re-exports from here for backward
compatibility.
"""
...
# ---- Transformer classes (moved from tukuy.transformers.html) ----------

@register_transformer("strip_html_tags")
...
@register_transformer("html_sanitize")
...
@register_transformer("link_extraction")
...
@register_transformer("extract_domain")
...
@register_transformer("html_extract", pattern={})
...
# ---- URL utility transformers (originally defined in plugins/html) -----

@register_transformer("resolve_url", base_url="")
